...
export default function ImageUploader() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-gray-800 text-white border border-gray-600 rounded px-3 py-2 shadow-sm"
          >
            {[1, 2, 3, 4].map((col) => (
      ...
      {images.length > 0 && (
        <div>
          <h2 className="text-lg font-semibold mt-6 mb-4 text-gray-700">Vista previa:</h2>
